...
export default function FloorPlanViewer() {
  ...
  return (
    <div className="w-1/2 ml-auto bg-white py-12 px-4 md:px-12 flex flex-col items-center">
      {/* Tabs */}
      <div className="flex flex-wrap justify-center gap-4 md:gap-8 mb-4 w-2/3 max-w-2xl bg-white rounded-xl shadow-sm border border-gray-100 p-2">
        {tabs.map((tab) => (
          <button
            key={tab}
